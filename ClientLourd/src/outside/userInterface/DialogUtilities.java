...
public class DialogUtilities {
	/**
	 * Ouvre une JOptionPane avec les valeurs données et retourne la valeur
	...
	public static String askChoiceFromOptions(JFrame parent, String title, String message, String[] options) {
		...
		String selection = (String) JOptionPane.showInputDialog(parent, message, title, JOptionPane.PLAIN_MESSAGE, null,
				options, options[0]);

		// Vérification de la réponse
		while (selection == null) {
			selection = (String) JOptionPane.showInputDialog(parent, message + "Attention ! Réponse incorrecte !",
